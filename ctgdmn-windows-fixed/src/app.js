...
const VIDEO_CATEGORIES=['Bắt đầu sử dụng','Quản lý dữ liệu','Xây dựng chương trình','Soạn giáo án','Nhận xét và phê duyệt','Xuất Word/Excel','AI và an toàn dữ liệu','Quản trị hệ thống'];
...
function renderPlanner(editId = '') {
  ...
  els.main.innerHTML = `${pageHead('Công cụ chuyên môn', 'Soạn giáo án 2026–2027', 'Soạn theo cấu trúc mở; có thể tiếp tục chỉnh sửa, sao lưu và chuyển sang máy khác.','<button class="ghost-button" data-guide-context="planner">Xem hướng dẫn</button>')}${workflowActions(plan)}
