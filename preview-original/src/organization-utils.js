...
export function defaultSchoolProfile(meta = {}) {
  return { id: 'school-main', name: clean(meta.schoolName) || 'TRƯỜNG MẦM NON', governingBody: '', address: '', phone: '', email: '', schoolCode: '', schoolYear: '2026–2027', principal: '', vicePrincipal: '', signingPlace: '', logoData: '', userEdited: false, updatedAt: now() };
}
...
export function migrateWorkspace(workspace = {}, meta = {}) {
  ...
  if (!schoolProfile.userEdited) schoolProfile.schoolYear = '2026–2027';
